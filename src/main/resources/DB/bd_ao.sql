...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2025 at 12:40 PM
...
CREATE TABLE `utilisateur` (
  ...
  `role` enum('admin','sous_admin','user','') NOT NULL,
...
(24, '$2a$10$4XUl7MHqd9T/2UqCUryVsucvXsza0qmEIRUxsb8b2KH1arDzaNrW2', 'admin', 'admin', 'DPF'),
(28, '$2a$10$cND5tnPWVT2YAzA5MrZc5.V/ERfNjbYrcKwE4WkDzR8rLzJv8uTG2', 'kafih', 'sous_admin', 'DA');
