...
const Test2 = () => {
    ...
    const currentYear = 2025; // Année fixée à 2025 comme demandé
    ...
    const getAllBandeCommandes = (entiteF, typeMarcheF, filter) => {
        BandeCommandeService.getAllBandeCommandes(entiteF, typeMarcheF, filter)
            .then((response) => {
                // Filtrer pour exclure les BC avec dateJugement non null ET année < 2025
    ...
    return (
        <div className="container-fluid">
            <h2 className="filter-section-title text-center">
                Liste des bons de commande (excluant les jugés avant {currentYear})
            </h2>
